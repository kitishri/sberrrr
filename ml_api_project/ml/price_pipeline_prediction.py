from configs.directories import BASE_PATH,CAR_DATA_TRAIN,CAR_DATA_TEST,CAR_DATA_MODELS,CAR_DATA_PREDICTIONS
...
df = pd.read_csv(CAR_DATA_TRAIN / 'cars_data.csv')
...
model_filename = f'{BASE_PATH}/data/models/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
